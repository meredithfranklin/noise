...
try:
    # Skips rows 1 to 253605 (skipping rows inclusive of 1, exclusive of 253606)
    # So, we get the data after the gap: "2024-03-14 16:42:00 UTC" to "2024-06-01 05:05:00 UTC"
    df_post = pd.read_csv(r"C:\Users\franc\PycharmProjects\Summer_research\Codes\sound_pollutant_met_data.csv", skiprows = list(range(1, 253606)))
    print(df_post.head())
